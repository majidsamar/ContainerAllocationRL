...
folder_path = f'ContainerAllocationRL/topView/outputs/{BAYS}{ROWS}{TIERS}_{NUM_CONTAINERS_PER_EPISODE}_{rsn}'
...
class ContainerYardEnv:
    ...
    def get_state(self):
        ...
        state = np.concatenate([self.yard_top_view.flatten(), self.stack_height.flatten(), future_containers])
        return state
